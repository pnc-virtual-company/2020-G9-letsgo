...
<div class="bs-example">
    <ul id="myTab" class="nav nav-pills">
        <li class="nav-item">
            <a href="#card-event" class="nav-link active">CARD</a>
        </li>

        <li class="nav-item">
            <a href="#calendar-event" class="nav-link">CALENDAR</a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane fade show active" id="card-event">
                    ...
                    <?php foreach($eventData as $eventValue) :?>
                        ...
                        if( $getUser['id'] != $eventValue['user_id'] ): 
                            ...
                            <div class="col-sm-12" id="event">
                                ...
                                <div class="card mt-4 card-explore"  >
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <br>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class=" col-sm-5 mt-4">
                                                    ...
                                                    <img src="images/event_image/<?= $eventValue['image']; ?>" class="rounded img-explore"  style="width: 180px; margin-top: 15px; height: 180px">
        ...
        <div class="tab-pane fade" id="calendar-event">
            <div class="container mt-5">
                <div id='calendar'></div>
            </div>
        </div>
